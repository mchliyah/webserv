...
/*   Updated: 2023/03/30 10:15:50 by slahrach         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void client::execute()
{
	std::cout << "-"<< getValue("Cookie")  << "-"<< std::endl;
	std::cout << "-"<< getValue("Method") << "-" << std::endl;
	std::cout <<  "-"<< getValue("version") << "-"<< std::endl;
	std::cout <<  "-"<< getValue("URL") << "-"<< std::endl;
	std::cout <<  "-"<< getValue("Host") << "-"<< std::endl;
